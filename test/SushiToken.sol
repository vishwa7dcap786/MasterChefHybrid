...
contract SushiToken is ERC20, Ownable   {
    ...
    uint256 private constant _cap = type(uint256).max;
    ...
    constructor() ERC20("SushiToken", "SUSHI") Ownable(msg.sender) { }
    ...
    function authorizedMint(address _account, uint256 _amount) external onlyAuthorizedMinter {
        require(totalSupply() + _amount <= _cap, "Mint would exceed the hard cap of 100");
